<div align="center">
  ...
  <h1>sprinkles-vscode</h1>
  <p>A <a href="https://en.wikipedia.org/wiki/Sprinkles">sprinkled</a> syntax theme with vibrant pops of colors 🍩</p>
...
```js
import { dark, light } from "sprinkles-vscode";
```
