...
const theme = (type: Variant): Theme => {
  ...
  return {
    ...
    type,
    colors: {
      "activityBar.activeBorder": colors.canvas.border.sidebar,
      "activityBar.activeFocusBorder": colors.canvas.border.sidebar,
      "activityBar.background": colors.canvas.background.default,
      "activityBar.foreground": colors.canvas.foreground.default,
      "activityBar.inactiveForeground": colors.canvas.foreground.muted,
      "activityBarBadge.background": colors.canvas.badge.background,
      "activityBarBadge.foreground": colors.canvas.badge.foreground,
      ...
      "editorGroup.border": colors.canvas.border.overlay,
      ...
      "editorGroupHeader.tabsBorder": colors.canvas.border.overlay,
      ...
      "list.activeSelectionBackground": colors.canvas.background.defaultActive,
      ...
      "list.inactiveSelectionBackground":
        colors.canvas.background.defaultActive,
      ...
      "panel.border": colors.canvas.border.overlay,
      ...
      "sideBar.border": colors.canvas.border.overlay,
      ...
      "statusBar.border": colors.canvas.border.overlay,
      ...
      "tab.activeBorder": colors.canvas.border.overlay,
      "tab.border": colors.canvas.border.overlay,
      "tab.inactiveBackground": colors.canvas.background.default,
      "tab.unfocusedActiveBorder": colors.canvas.border.overlay,
      "tab.unfocusedActiveBorderTop": colors.canvas.border.overlay,
      ...
      "titleBar.border": colors.canvas.border.overlay,
